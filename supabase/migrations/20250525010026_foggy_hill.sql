/*
  # Create storage buckets for meal and gift photos

  1. New Buckets
    - meal_photos: For storing meal option images
    - gift_photos: For storing gift registry item images

  2. Security
    - Enable public access for viewing photos
    - Add policies for authenticated users to upload photos
*/
